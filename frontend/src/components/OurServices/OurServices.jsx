  ...
  return (
    <div className="w-full flex flex-wrap justify-center items-center space-y-6 py-12">
      ...
      <div className="w-full flex flex-wrap justify-center items-center">
        <a
          href="/proyectos"
          className="w-full lg:w-1/2 flex flex-wrap justify-center items-start h-auto space-y-3"
        >
          <div
        ...
        <div className="w-full lg:w-1/2 flex flex-wrap justify-center items-start h-auto space-y-3">
          <a href="/proyectos">
            <div
              className="relative cursor-pointer overflow-hidden"
              onMouseEnter={handleMouseEnter}
