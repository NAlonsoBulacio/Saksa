...
const Counter = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-wrap justify-center items-start lg:items-center px-0 lg:px-10 notranslate text-center gap-y-4 lg:space-y-0 ">
        <div className="w-[46%] md:w-1/3 flex flex-wrap justify-start items-center">
          <div
            ref={ref1}
          ...
          <div className="w-full lg:w-full flex justify-start lg:justify-center px-0 lg:px-6">
            <h1
              ref={ref3}
              className={`${
                inView3 ? "animatable-type" : "initial-type"
              }  text-emerald-700 text-xl 2xl:text-2xl text-center`}
            >
              Metros cuadrados construidos.
            </h1>
          </div>
        </div>
        <div className="w-[46%] md:w-1/3 flex flex-wrap justify-center items-start lg:items-center lg:border-l-2 border-green-600">
          <div
            ref={ref2}
        ...
        <div className="w-full h-full md:w-1/3 flex flex-wrap justify-center items-center lg:border-l-2 border-green-600">
          ...
          <div className="w-full justify-center lg:justify-center">
            <h1
              ...
              className={`${
                inView3 ? "animatable-type" : "initial-type"
              } text-emerald-700 text-xl 2xl:text-2xl text-center lg:text-center`}
            >
