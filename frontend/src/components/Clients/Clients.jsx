  ...
  return (
    <div className="flex flex-wrap justify-center items-center py-20">
      <div className="w-full flex justify-center items-center ">
        <h1 className="text-gray-800 text-2xl font-barlow-400 tracking-[0.3rem]">NUESTROS CLIENTES </h1>
      </div>
      <div className="w-full flex justify-center ">
            <div className="w-1/5">
              <hr className="my-2 border-[1.5px] border-gray-600" />
            </div>
          </div>
      {/* <div className="w-full flex justify-center items-center">
      ...
      <ul className="flex flex-wrap justify-center items-center py-4 lg:py-12 px-0 lg:px-0 xl:px-20 space-x-8">
