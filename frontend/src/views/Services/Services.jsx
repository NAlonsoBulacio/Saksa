...
const Services = () => {
  return (
    <div>
      <FlyerAbout />
      <div className="bg-gray-100 flex flex-wrap justify-center items-center lg:px-10 xl:px-32 space-y-8 py-10">
        <div className="w-full flex flex-wrap justify-center items-center  space-y-6">
          <h1 className="text-4xl tracking-[0.2rem] font-glacial-bold text-green-800">
            NUESTROS SERVICIOS
          </h1>
          <p className="w-full px-16 text-xl text-center">
        ...
        <div className="flex justify-center items-start space-x-0 lg:space-x-8">
          <div className="w-[60%] flex items-start overflow-hidden rounded-lg">
            <img
          ...
          <div className="w-[30%] flex flex-wrap justify-start items-start px-10">
